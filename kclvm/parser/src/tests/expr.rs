...
parse_expr_snapshot!(primary_expr_3, r####"{}.a"####);
parse_expr_snapshot!(primary_expr_4, r####"{}..a"####);
parse_expr_snapshot!(primary_expr_5, r####"{}...a"####);
parse_expr_snapshot!(primary_expr_6, r####"[]..a"####);
parse_expr_snapshot!(primary_expr_7, r####"{}[[]"####);
