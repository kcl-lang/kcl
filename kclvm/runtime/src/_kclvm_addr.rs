...
pub fn _kclvm_get_fn_ptr_by_name(name: &str) -> u64 {
	match name {
		...
		"kclvm_debug_print_value_json_string" => crate::kclvm_debug_print_value_json_string as *const () as u64,
		...
		"kclvm_value_function_external_invoke" => crate::kclvm_value_function_external_invoke as *const () as u64,
		"kclvm_value_function_get_closure" => crate::kclvm_value_function_get_closure as *const () as u64,
		"kclvm_value_function_invoke" => crate::kclvm_value_function_invoke as *const () as u64,
		"kclvm_value_function_is_external" => crate::kclvm_value_function_is_external as *const () as u64,
