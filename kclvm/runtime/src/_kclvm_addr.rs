...
pub fn _kclvm_get_fn_ptr_by_name(name: &str) -> u64 {
    match name {
        ...
        "kclvm_type_Any" => crate::kclvm_type_Any as *const () as u64,
        "kclvm_type_Bool" => crate::kclvm_type_Bool as *const () as u64,
        "kclvm_type_BoolLit" => crate::kclvm_type_BoolLit as *const () as u64,
        "kclvm_type_BoolLit_value" => crate::kclvm_type_BoolLit_value as *const () as u64,
        "kclvm_type_Dict" => crate::kclvm_type_Dict as *const () as u64,
        "kclvm_type_Float" => crate::kclvm_type_Float as *const () as u64,
        "kclvm_type_FloatLit" => crate::kclvm_type_FloatLit as *const () as u64,
        "kclvm_type_FloatLit_value" => crate::kclvm_type_FloatLit_value as *const () as u64,
        "kclvm_type_Func" => crate::kclvm_type_Func as *const () as u64,
        "kclvm_type_Int" => crate::kclvm_type_Int as *const () as u64,
        "kclvm_type_IntLit" => crate::kclvm_type_IntLit as *const () as u64,
        "kclvm_type_IntLit_value" => crate::kclvm_type_IntLit_value as *const () as u64,
        "kclvm_type_List" => crate::kclvm_type_List as *const () as u64,
        "kclvm_type_Schema" => crate::kclvm_type_Schema as *const () as u64,
        "kclvm_type_Str" => crate::kclvm_type_Str as *const () as u64,
        "kclvm_type_StrLit" => crate::kclvm_type_StrLit as *const () as u64,
        "kclvm_type_StrLit_value" => crate::kclvm_type_StrLit_value as *const () as u64,
        "kclvm_type_Union" => crate::kclvm_type_Union as *const () as u64,
        ...
        "kclvm_value_union_with" => crate::kclvm_value_union_with as *const () as u64,
